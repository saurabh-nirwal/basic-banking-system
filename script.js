 ...
 var enterSName = document.getElementById("enterSName").value;
  var findSenderBankAccount = enterSName + "BankBalance";
    ...
    if (enterAmount > enterSAmount) {
       ...
       $${enterAmount} is sent to ${enterName}@coopbank.com.`)
 
       // transaction history 
       var createPTag = document.createElement("li");
       var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the sender with Email-id ${enterSName}@coopbank.com
  to recepient with Email-id ${enterName}@coopbank.com on ${Date()}.`);
